...
command ${install_method} install -n ${ENV_NAME} -c pytorch -c conda-forge nibabel=4.0.2 pytorch=1.11 torchvision matplotlib pandas ipykernel ipympl ffmpeg monai tqdm
